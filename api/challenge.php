...
if ($_SERVER['REQUEST_METHOD'] === 'GET' && $action === 'generate') {
    ...
    $system = 'You are a STRICT German grammar checker for a language learning app. '
        ...
        . '(3) Articles: a missing article on a SINGULAR countable noun is an error (e.g. "Du nimmst Buch" → wrong; "Du nimmst ein Buch" → correct). '
        . 'BUT: bare PLURAL nouns without an article are perfectly correct German and MUST be accepted ("Ihr bringt Geschenke", "Wir kaufen Äpfel", "Sie schreiben Briefe" are all correct). '
        . 'Mass/abstract nouns without an article are also correct ("Wir trinken Wasser", "Ich habe Hunger"). '
